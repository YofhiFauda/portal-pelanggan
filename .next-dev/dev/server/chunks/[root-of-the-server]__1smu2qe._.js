...
function getSessionSecret() {
    ...
    if (!secret || secret.length < 32) {
        throw new Error('SESSION_COOKIE_SECRET belum diset atau kurang dari 32 karakter — cek .env/.env.local.');
    }
    return secret;
}
 ...
 */ function isCookieWriteRestrictedError(err) {
    return err instanceof Error && err.message.includes('Cookies can only be modified in a Server Action or Route Handler');
}
...
function proxy(request) {
    const hasSession = request.cookies.has(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["SESSION_COOKIE_NAME"]);
    const isAuthPage = [
        '/login',
        '/aktivasi',
        '/klaim'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1smu2qe._.js.map