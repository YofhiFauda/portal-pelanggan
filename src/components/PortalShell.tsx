  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-x-hidden">
        {/* Top Navbar */}
        <header className="sticky top-0 z-20 flex items-center justify-between border-b border-border bg-surface/90 backdrop-blur-md px-6 py-4">
        ...
        {/* Main Content Area */}
        <main className="flex-1 px-6 py-8 pb-28 md:pb-8 animate-fade-in-up">
          {children}
        </main>
      </div>
